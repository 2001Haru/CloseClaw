...
class ConsensusGuardian:
    ...
    DEFAULT_PROMPT = (
        ...
        "Reject dangerous commands, such as attempts to delete all files, delete a great many emails in the inbox, or destroy any valuable local or cloud-based digital assets; Approve routine commands, such as editing a document and running a test."
